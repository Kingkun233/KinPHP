...
class mysql
{
    ...
    private function __construct($config)
    {
        extract($config);
        try {
            $this->_pdo = new PDO($dsn, $dbuser, $dbpsw, [PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES ' . $dbcharset, PDO::ATTR_PERSISTENT => true]);
    ...
    //查询
    public function select($_tables, Array $_field, Array $_param = array())
    {
